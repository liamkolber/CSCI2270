...
class MovieTree {
    ...
    private:
        ...
        void insertnode(MovieNode * node);
        ...
        int countNodes(MovieNode * node,int count); //number of unique titles in the tree
        int countPath(MovieNode *node); //longest path from node to a leaf node in the tree
